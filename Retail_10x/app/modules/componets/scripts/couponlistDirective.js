 ...
 * */
 ...
 angular.module('Coupons.salesperformance', ['product.controllers','individualproduct.controllers'])

 .directive('couponlistDirective', ['$compile', '$window', '$timeout','dashBoardService','$rootScope','$filter',
  function ($compile, $window, $timeout,dashBoardService,$rootScope,$filter) {
    return {
      ...
      //console.log("record coming...",scope.record);
    ...
    },
    {
      ...
      inside: true,
         ...
         scope.avgSaleschange=function(salestotal){
              ...
              "campaignStartTime":scope.record.reportstartDate,
               "filters": {
                ...
                "retailerId" : scope.record.retailers
              }
            }
             ...
             scope.average=(scope.salesamtRT+scope.totalsales)/2;
              ...
              scope.decrease=scope.decrease/scope.average;
               ...
               scope.record.campaignRatio=scope.decreasepercent.toFixed();
                  ...
                  var object={
              "couponId":scope.record.couponId,
              "ratio":scope.percent,
              "status":scope.status
          ...
          dashBoardService.avgsalesDataforcpg(avgsalesData).then(function (response) {
             ...
             // console.log("days...",days);
              ...
              scope.percent="";
                    ...
                    // console.log("total sales...",scope.totalsales);
                    //console.log("salesAmtRt....",scope.salesamtRT);
            ...
            // console.log("coupon ratio...",object);
          ...
          scope.salesDatalinechartforCampaigns=function(){
           ...
           if(i==0){
              ...
              else if(scope.ProductsbyRT){
                 if(scope.ProductsbyCT[i]){
               var linechartdataobject={
                 "date": scope.ResultDate,
                  "date1":scope.ResultDate1,
                 "lineColor": "rgb(66, 141, 201)",
           ...
           scope.showchart=true;
            //console.log("value....",scope.chartdata);
       ...
       scope.chartdata[i].amtnumber1=$filter('number')(scope.chartdata[i].value1,2);
        ...
        if(scope.salesDatatotal==undefined){
