...
angular.module('Retails.categories', ['manufacturer .controllers'])

  .directive('categoriesDirective', ['$compile', '$window', '$timeout','$rootScope','$filter',
    function ($compile, $window, $timeout,$rootScope,$filter) {
      return {
        ...
        templateUrl: 'modules/componets/views/categoriesproductItemtemplate.html',
