...
angular.module('Retails.alldepartmentsDirective', [])

  .directive('alldepartmentbarchartDirective', ['$compile', '$window', '$timeout','$rootScope','productService','dashBoardService','$filter',
    function ($compile, $window, $timeout,$rootScope,productService,dashBoardService,$filter) {
      return {
        ...
        templateUrl: 'modules/componets/views/alldepartmentstemplate.html',
