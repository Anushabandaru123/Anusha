...
angular.module('Retails.categoriesunderdepartment', ['manufacturer .controllers'])

  .directive('categoriesunderdepartmentDirective', ['$compile', '$window', '$timeout','$rootScope','$filter',
    function ($compile, $window, $timeout,$rootScope,$filter) {
      return {
        ...
        templateUrl: 'modules/componets/views/categoriestemplate.html',
        ...
        link: function (scope, element, attrs ) {
          ...
          var initChart = function () {
            ...
            function handleClick(event){
              ...
              //$rootScope.$emit('selectedcategoriesname', object);
