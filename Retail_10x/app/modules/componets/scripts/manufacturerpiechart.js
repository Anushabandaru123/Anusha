...
angular.module('Retails.manufacturerpiechartDirective', ['department.controllers'])

  .directive('manufacturerpiechartDirective', ['$compile', '$window', '$timeout','$rootScope','productService','dashBoardService',
    function ($compile, $window, $timeout,$rootScope,productService,dashBoardService) {
      return {
        ...
        templateUrl: 'modules/componets/views/manufacturerpiecharttemplate.html',
             ...
             "listeners": [{
                ...
                "method": function(e) {
                  ...
                  if(scope.selectoption1!="OTHERS"){
                    ...
                    $rootScope.$emit('manufacturerpiechartcallback', object);
