  ...
  e.AmRectangularChart = e.Class({
    inherits: e.AmCoordinateChart, construct: function (a) {
      ...
      if (!a.zbSet) {
        ...
        var c = a.color, d = a.fontSize, g = a.zoomOutButtonImageSize, h = a.zoomOutButtonImage.replace(/\.[a-z]*$/i, ""), f = e.lang.zoomOutText || a.zoomOutText, l = a.zoomOutButtonColor, k = a.zoomOutButtonAlpha, m = a.zoomOutButtonFontSize, p = a.zoomOutButtonPadding;
        isNaN(m) || (d = m);
        ...
        var r = m = 0, r = a.pathToImages;
        if (h) {
          if (e.isAbsolute(h) || void 0 === r)r = "";
          n = a.container.image(r + h + a.extension, 0, 0, g, g);
...
(function () {
  ...
  e.AmSerialChart = e.Class({
    ...
    initChart: function () {
      ...
      isNaN(c) || (b != this.endTime &&
      b - a > c && (a = b - c), a != this.startTime && b - a > c && (b = a + c));
      ...
      var a = 0, b = this.valueAxes.length,
        c = this.graphs.length, d, g, e = !1, f, l;
      for (l = 0; l < b; l++) {
        g = this.valueAxes[l];
        ...
        if ("none" == k || "3d" == k) {
          e = !1;
          for (f = 0; f < c; f++)d = this.graphs[f], d.valueAxis == g && "column" == d.type && (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) :
      ...
      return c == l ? f : 1 >= e - g ? d ? g : Math.abs(a[g][b] - c) < Math.abs(a[e][b] - c) ? g : e : c == l ? f : c < l ? this.getClosestIndex(a, b,
      ...
      if (c)if (this.categoryAxis.equalSpacing) {
        ...
        c = this.getClosestIndex(c, "time", b.getTime(),
          !1, 0, c.length);
        this.zoom(d, c)
      ...
      if (b) {
        ...
        for (var l = 0; l < c.length; l++) {
          for (var k = c[l], m = 0, p =
            0, n = 0, r = 0, w, y, u, q, E, v, t, x, B, A, G = this.start; G <= this.end; G++) {
            var D = h[G];
            if (D) {
              var C = D.axes[g.id].graphs[b.id];
              if (C) {
                if (C.values) {
                  var z = C.values[k], D = D.x.categoryAxis;
                  if (this.rotate) {
          ...
          m = {open: w, close: y, high: q, low: u, average: E, sum: m, count: p};
          n = {open: v, close: t, high: B, low: x, average: A, sum: n, count: r};
      ...
      if (b) {
        ...
        if (void 0 !==
          ...
          g || (g = this.nf);
          h = b.graph.valueAxis;
          (f = h.duration) && !isNaN(b.values.value) && (f = e.formatDuration(b.values.value, f, "", h.durationUnits,
            h.maxInterval, g), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), f));
      ...
      if (a) {
        ...
        var h = a.valueZoomable,
          f = a.zoomable, l = a.valueLineEnabled;
        ...
        b && (b.balloonTextFunction = a.categoryBalloonFunction,
          a.categoryLineAxis = b, b.balloonText = a.categoryBalloonText, a.categoryBalloonEnabled && ((f = b.balloon) || (f = {}), f = e.extend(f, this.balloon, !0), f.fillColor = d, f.balloonColor = d, f.fillAlpha = c, f.borderColor = d, f.color = g, b.balloon = f), b.balloon && (b.balloon.enabled = a.categoryBalloonEnabled))
      }
      ...
      if (b + 1 < c.length)for (b += 1; b < c.length; b++)if (a =
          c[b])if (a = a.axes[d.valueAxis.id].graphs[d.id], !isNaN(a.y))return a
      ...
      isNaN(f) || isNaN(l) || (a = this.categoryAxis, a.parseDates && !a.equalSpacing ? this.zoomToDates(new Date(f),
        new Date(l)) : this.zoomToIndexes(f, l))
      ...
      e.AmSerialChart.base.handleCursorMove.call(this,
        a);
        ...
        if (d) {
          ...
          if (g = this.chartData[g]) {
            ...
            if (this.prevCursorItem != g || k != this.prevMostCloseGraph) {
              m = [];
              for (h = 0; h < d.length; h++)f = d[h], l = f.valueAxis.id, l = g.axes[l].graphs[f.id], b.showNextAvailable && isNaN(l.y) && (l = this.getNextItem(l)), k && f != k ? (f.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha), f.balloon.hide(0)) : b.valueBalloonsEnabled ? (f.balloon.showBullet = b.bulletsEnabled, f.balloon.bulletSize =
                b.bulletSize / 2, a.hideBalloons || (f.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha), f.balloon.set && m.push({
                balloon: f.balloon,
      ...
      for (c =
             0; c < f; c++)d = a[c].balloon, d.setBounds(0, 0, h, b), d.restorePrevious(), d.draw(), b = d.yPos - 3;
      a.reverse();
      for (c = 0; c < f; c++) {
        d = a[c].balloon;
...
(function () {
  ...
  e.Cuboid = e.Class({
    construct: function (a, b, c, d, e, h, f, l, k, m, p, n, r, w, y, u, q) {
      ...
      var a = this.set;
      a.clear();
      var b = this.container, c = b.chart, d = this.w, g = this.h, h = this.dx, f = this.dy, l = this.colors, k = this.alpha, m = this.bwidth, p = this.bcolor, n = this.balpha, r = this.gradientRotation, w = this.cornerRadius, y = this.dashLength, u = this.pattern, q = this.topRadius, E = this.bcn, v = l, t = l;
      "object" == typeof l && (v = l[0], t = l[l.length - 1]);
      var x, B, A, G, D, C, z, L, M, Q = k;
      u && (k = 0);
      var F, H, I, J, K = this.rotate;
      if (0 < Math.abs(h) || 0 < Math.abs(f))if (isNaN(q))z = t, t = e.adjustLuminosity(v, -.2), t = e.adjustLuminosity(v, -.2), x = e.polygon(b, [0, h, d + h, d, 0], [0, f, f, 0, 0],
        ...
        var N, O, P;
        K ? (N = g / 2, t = h / 2, P = g / 2, O =
          d + h / 2, H = Math.abs(g / 2), F = Math.abs(h / 2)) : (t = d / 2, N = f / 2, O = d / 2, P = g + f / 2 + 1, F = Math.abs(d / 2), H = Math.abs(f / 2));
        I = F * q;
        J = H * q;
      ...
      d = isNaN(q) ? 0 > g ? [x,
        M, B, A, G, D, C, z, L, b] : [z, L, B, A, G, D, x, M, C, b] : K ? 0 < d ? [x, b, z] : [z, b, x] : 0 > g ? [x, b, z] : [z, b, x];
      e.setCN(c, b, E + "front");
      e.setCN(c, B, E + "back");
      e.setCN(c, z, E + "top");
      ...
      e.setCN(c, G, E + "left");
      e.setCN(c, D, E + "right");
      for (x = 0; x < d.length; x++)if (B = d[x])a.push(B), e.setCN(c, B, E + "element");
  ...
  e.CategoryAxis = e.Class({
    inherits: e.AxisBase, construct: function (a) {
      ...
      if (e.ifArray(a)) {
        ...
        var d = this.start, g = this.labelFrequency, h = 0, f = this.end - d + 1, l = this.gridCountR, k = this.showFirstLabel, m = this.showLastLabel, p, n = "", n = e.extractPeriod(this.minPeriod), r = e.getPeriodDuration(n.period, n.count), w, y, u, q, E = this.rotate;
        ...
        if (this.parseDates && !this.equalSpacing)this.lastTime = a[a.length - 1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * r), this.minPeriod,
          ...
          if (this.cellWidth = this.getStepWidth(f), f < l && (l = f), h += this.start, this.stepWidth = this.getStepWidth(f), 0 < l)for (v = Math.floor(f / l), r = this.chooseMinorFrequency(v), f = h, f / 2 == Math.round(f / 2) && f--, 0 > f && (f = 0), l = 0, this.widthField && (f = this.start), this.end - f + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = f; b <= this.end + 2; b++) {
            p = !1;
            0 <= b && b < this.data.length ? (w = this.data[b], n = w.category,
              p = w.forceShow) : n = "";
            if (q && !isNaN(r))if (b / r == Math.round(b / r) || p)b / v == Math.round(b / v) || p || (this.gridAlpha = this.minorGridAlpha, n = void 0); else continue; else if (b / v != Math.round(b / v) && !p)continue;
            ...
            l++;
            A = this.cellWidth;
            E && (A = NaN, this.ignoreAxisWidth || !c.autoMargins) && (A = "right" == this.position ?
          ...
          q && 1 < w && (r = this.chooseMinorFrequency(w), e.getPeriodDuration(g,
            r));
          if (0 < this.gridCountR)for (b = f; b < B; b++)if (r = this.data[b].time, this.checkPeriodChange(g, w, r, n) && b >= A) {
            ...
            if (b == d && !k || b == l && !m)n = " ";
            a ? a = !1 : (v || (t = !1), f - this.previousPos > this.safeDistance *
            Math.cos(this.labelRotationR * Math.PI / 180) && (this.labelFunction && (n = this.labelFunction(n, new Date(r), this, g, w, u)), this.boldLabels && (t = !0), u = new this.axisItemRenderer(this, f, n, void 0, void 0, void 0, void 0, t), q = u.graphics(), this.pushAxisItem(u), q = q.getBBox().width, e.isModern || (q -= f), this.previousPos = f + q));
            u = n = r
          }
        }
        ...
        if (this.widthField)for (b = this.start; b <= this.end; b++)t = this.data[b], d = t.widthValue, t.percentWidthValue = d / x * 100, this.rotate ? (m = this.height * d / x / 2 + k, k = this.height * d / x + k) : (m = this.width * d / x / 2 + k, k = this.width * d / x + k), t.x[this.id] = m;
        x = this.guides.length;
        for (b = 0; b < x; b++)if (k = this.guides[b], p = v = v = q = d = NaN, m = k.above, k.toCategory && (v = c.getCategoryIndexByValue(k.toCategory), isNaN(v) || (d = this.getCoordinate(v - h), k.expand &&
          ...
          (p = !1), u = "H" == this.orientation ? new this.axisItemRenderer(this, q, k.label, p, 2 * v, NaN, k) : new this.axisItemRenderer(this, q, k.label, !1, NaN, v, k), this.pushAxisItem(u, m)), 0 < d || 0 < q) {
          p = !1;
          if (this.rotate) {
        ...
        if (c = c.chartCursor)E ? c.fixHeight(this.cellWidth) : (c.fixWidth(this.cellWidth), c.fullWidth &&
        this.balloon && (this.balloon.minWidth = this.cellWidth));
      ...
      if (this.stickBalloonToCategory) {
        ...
        if (d) {
          ...
          this.rotate ? ("left" == this.position ? (f && (h -= d.width), 0 < h && (h = 0)) : 0 > h && (h = 0), d.fixHLine(a, h)) : ("top" == this.position ? (f && (h -= d.height),
