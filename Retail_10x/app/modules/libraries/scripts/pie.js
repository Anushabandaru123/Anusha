    ...
    inherits: k.AmChart, construct: function (a) {
      ...
      if (void 0 !== b) {
        ...
        for (g = 0; g < c; g++) {
          ...
          var e = b[g];
          f.dataContext = e;
          null !== e[this.valueField] && (f.value =
            Number(e[this.valueField]));
...
(function () {
  ...
  k.AmPieChart = k.Class({
    inherits: k.AmSlicedChart, construct: function (a) {
      ...
      if (k.ifArray(a)) {
        if (0 < this.realWidth && 0 < this.realHeight) {
          ...
          var f = k.toCoordinate, h = f(this.marginLeft, d), e = f(this.marginRight, d), z = f(this.marginTop, g) + this.getTitleHeight(), n = f(this.marginBottom, g) + this.depth3D,
            A, B, l, x = k.toNumber(this.labelRadius), q = this.measureMaxLabel();
          ...
          for (var E, h = 0; h < a.length; h++)if (e = a[h], !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents)) {
            var r = 360 *
              e.percents / 100, q = Math.sin((n + r / 2) / 180 * Math.PI), C = d / l * -Math.cos((n + r / 2) / 180 * Math.PI), p = this.outlineColor;
            p || (p = e.color);
            var v = this.alpha;
            ...
            if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
              ...
              t = e.labelColor;
              t || (t = this.color);
              "" !== m && (m = k.wrappedText(c, m, t, this.fontFamily, this.fontSize, w, !1, this.maxLabelWidth), k.setCN(this, m, "pie-label"), k.setCN(this, m, e.className, !0), m.translate(r + 1.5 * u, D), m.node.style.pointerEvents = "none", e.ty = D, e.textX = r + 1.5 * u, v.push(m),
                this.axesSet.push(v), e.labelSet = v, e.label = m);
              e.tx = r;
              e.tx2 = r + u;
              e.tx0 = A + q * l;
              e.ty0 = B + C * l
      ...
      for (d = b - 1; 0 <= d; d--)c =
        a[d], 0 !== c.labelQuarter || c.hidden || this.checkOverlapping(d, c, 0, !0, 0);
      ...
      if (n) {
        if (!0 === d)for (h = a + 1; h < k; h++)e[h].labelQuarter == c && (f = this.checkOverlappingReal(b,
          e[h], c)) && (h = k); else for (h = a - 1; 0 <= h; h--)e[h].labelQuarter == c && (f = this.checkOverlappingReal(b, e[h], c)) && (h = 0);
