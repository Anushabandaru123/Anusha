(function () {
  ...
  d.Class = function (a) {
    ...
    a.inherits ? (b.prototype = new a.inherits(d.inheriting), b.base = a.inherits.prototype, delete a.inherits) : (b.prototype.createEvents =
      ...
      for (var b = this.events[a.type], c = 0, d = b.length; c <
      d; c++) {
        var k = b[c];
  ...
  d.applyLang = function (a, b) {
    ...
    b.amString = "am";
    b.pmString = "pm";
    c && (c = c[a]) && (d.lang = c, c.monthNames && (b.dayNames =
      d.extend({}, c.dayNames), b.shortDayNames = d.extend({}, c.shortDayNames), b.monthNames = d.extend({}, c.monthNames), b.shortMonthNames = d.extend({}, c.shortMonthNames)), c.am && (b.amString = c.am), c.pm && (b.pmString = c.pm))
  };
...
(function () {
  ...
  d.extend = function (a, b, c) {
    var e;
    a || (a = {});
    for (e in b)c ? a.hasOwnProperty(e) ||
    (a[e] = b[e]) : a[e] = b[e];
    return a
  };
  ...
  d.easeOutElastic = function (a, b, c, e, d) {
    ...
    if (1 == (b /= d))return c + e;
    f || (f = .3 * d);
    h < Math.abs(e) ? (h = e, a = f / 4) : a = f / (2 * Math.PI) * Math.asin(e /
        h);
  ...
  d.AmChart = d.Class({
    construct: function (a) {
      ...
      this.prefixesOfSmallNumbers = [{
        number: 1E-24,
        prefix: "y"
      }, {number: 1E-21, prefix: "z"}, {number: 1E-18, prefix: "a"}, {number: 1E-15, prefix: "f"}, {
        number: 1E-12,
        prefix: "p"
      ...
      if (d.ifArray(b)) {
        ...
        for (e = 0; e < b.length; e++) {
          ...
          if (!1 !== g.enabled) {
            ...
            f = d.wrappedText(this.container, g.text, f, this.fontFamily,
              h, "middle", l, this.realWidth - 35);
      ...
      this.checkDisplay();
      a.chart = this;
      d.VML || d.SVG ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness = this.handDrawThickness, d.remove(this.set), this.set = a.set(), d.remove(this.gridSet), this.gridSet = a.set(), d.remove(this.cursorLineSet), this.cursorLineSet = a.set(), d.remove(this.graphsBehindSet),
        ...
        this.axesLabelsSet = a.set(), d.remove(this.balloonsSet), this.balloonsSet = a.set(), d.remove(this.plotBalloonsSet), this.plotBalloonsSet = a.set(), d.remove(this.zoomButtonSet), this.zoomButtonSet = a.set(), d.remove(this.zbSet), this.zbSet = null, d.remove(this.linkSet), this.linkSet = a.set()) : this.fire({
        type: "failed",
        chart: this
      })
    }, premeasure: function () {
      ...
      if (this.container && !1 !== a.enabled) {
        ...
        "left" == e && (e = "start");
        "right" == e && (e = "end");
        "center" == e && (e = "middle", h ? b = this.realHeight - b + b / 2 : m = this.realWidth / 2 - m);
        void 0 === k && (k = 1);
        void 0 === h && (h = 0);
        b += g / 2;
      ...
      a =
      {x: a, y: b, text: c, align: e, size: d, color: f, alpha: k, rotation: h, bold: l, url: m, enabled: !0};
      ...
      var a = this.divRealWidth,
        b = this.divRealHeight, c = this.legend;
      if (c) {
      ...
      this.handleMouseMove();
      var f = this.balloon;
      f.enabled && (f.followCursor(!1), f.changeColor(b), !c || f.fixedPosition ? (f.setPosition(e, d), isNaN(e) || isNaN(d) ? f.followCursor(!0) : f.followCursor(!1)) : f.followCursor(!0),
      a && f.showBalloon(a))
  ...
  d.AmBalloon = d.Class({
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          var h = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, r = this.fillColor, v = this.borderColor, p = r;
          void 0 != n && (this.adjustBorderColor ? p = v = n : r = n);
          var q = this.horizontalPadding, x = this.verticalPadding, B = this.pointerWidth, y = this.pointerOrientation, A = this.cornerRadius,
            w = c.fontFamily, z = this.fontSize;
          void 0 == z && (z = c.fontSize);
          var n = document.createElement("div"), D = c.classNamePrefix;
          n.className = D + "-balloon-div";
          this.className && (n.className = n.className + " " + D + "-balloon-div-" + this.className);
          D = n.style;
          this.disableMouseEvents && (D.pointerEvents = "none");
          D.position = "absolute";
          var t = this.minWidth, u = "";
          isNaN(t) || (u = "min-width:" + (t - 2 * q) + "px; ");
          n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + u + "max-width:" + this.maxWidth + "px; font-size:" + z + "px; color:" + this.color + "; font-family:" +
            w + '">' + this.text + "</div>";
          ...
          !isNaN(t) && u < t && (u = t);
          window.opera && (w += 2);
          var G = !1, z = this.offsetY;
          c.handDrawn && (z += c.handDrawScatter + 2);
          "H" != y ? (t = a - u / 2, b < k + w + 10 && "down" != y ? (G = !0, e && (b += z), z = b + B, this.deltaSignY = -1) : (e && (b -= z), z = b - w - B, this.deltaSignY = 1)) : (2 * B > w && (B = w / 2), z = b - w / 2, a < h + (l - h) / 2 ? (t = a + B, this.deltaSignX = -1) : (t = a - u - B, this.deltaSignX = 1));
          z + w >= m && (z = m - w);
          z < k && (z = k);
          t < h && (t = h);
          t + u > l && (t = l - u);
          var k = z + x, m = t + q, C = this.shadowAlpha, I = this.shadowColor, q = this.borderThickness, K = this.bulletSize, J, x = this.fillAlpha, L = this.borderAlpha;
          this.showBullet && (J = d.circle(g, K, p, x), f.push(J));
          this.drop ? (h = u / 1.6, l = 0, "V" == y && (y = "down"), "H" == y && (y = "left"), "down" == y && (t = a + 1, z = b - h - h / 3), "up" == y && (l = 180, t = a + 1, z = b + h + h / 3), "left" == y && (l = 270, t = a + h + h / 3 + 2, z = b), "right" == y && (l = 90, t = a - h - h / 3 + 2, z = b), k = z - F / 2 + 1, m = t - E / 2 - 1, r = d.drop(g, h, l, r, x, q, v, L)) : 0 < A || 0 === B ? (0 < C && (a = d.rect(g, u, w, r, 0, q + 1, I,
            C, A), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), r = d.rect(g, u, w, r, x, q, v, L, A)) : (p = [], A = [], "H" != y ? (h = a - t, h > u - B && (h = u - B), h < B && (h = B), p = [0, h - B, a - t, h + B, u, u, 0, 0], A = G ? [0, 0, b - z, 0, 0, w, w, 0] : [w, w, b - z, w, w, 0, 0, w]) : (y = b - z, y > w - B && (y = w - B), y < B && (y = B), A = [0, y - B, b - z, y + B, w, w, 0, 0], p = a < h + (l - h) / 2 ? [0, 0, t < a ? 0 : a - t, 0, 0, u, u, 0] : [u, u, t + u > a ? u : a - t, u, u, 0, 0, u]), 0 < C && (a = d.polygon(g, p, A, r, 0, q, I, C), a.translate(1, 1), f.push(a)), r = d.polygon(g, p, A, r, x, q, v, L));
          this.bg = r;
          f.push(r);
          r.toFront();
          ...
          D.left = m + "px";
          D.top = k + "px";
          f.translate(t - g, z, 1, !0);
          r = r.getBBox();
          this.bottom = z + w + 1;
          this.yPos = r.y + z;
          J && J.translate(this.pointToX - t + g, b - z);
          b = this.animationDuration;
          0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: t - g + "," + z}, b, "easeOutSine"), n && (D.left = this.prevTX + "px", D.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine",
...
(function () {
  ...
  d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    isNaN(k) && (k = g);
    var r = e, v = !1;
    "object" == typeof r && 1 < r.length && (v = !0, r = r[0]);
    void 0 === h && (h = r);
    ...
    h = Math.round;
    m && (b[p] = d.roundTo(b[p], 5), c[p] = d.roundTo(c[p], 5), h = Number);
    k = "M" + (h(b[0]) + n) + "," + (h(c[0]) + f);
    for (var p = 1; p < b.length; p++)m && (b[p] = d.roundTo(b[p], 5), c[p] = d.roundTo(c[p], 5)), k += " L" + (h(b[p]) + n) + "," + (h(c[p]) + f);
    a = a.path(k + " Z").attr(g);
    v && a.gradient("linearGradient", e, l);
    return a
  };
  d.rect = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    v && a.gradient("linearGradient", e, m);
    return a
  };
  d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, r, v) {
    ...
    switch (b) {
      case "round":
        p = d.circle(a, c / 2, e, g, f, h, k);
        break;
      case "square":
        p = d.polygon(a, [-c /
        2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, v);
        break;
      case "rectangle":
        p = d.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, v);
        break;
      case "diamond":
        p = d.polygon(a, [-c / 2, 0, c / 2, 0], [0, -c / 2, 0, c / 2], e, g, f, h, k);
        break;
      case "triangleUp":
        p = d.triangle(a, c, 0, e, g, f, h, k);
        break;
      case "triangleDown":
        p = d.triangle(a, c, 180, e, g, f, h, k);
        break;
      case "triangleLeft":
        p = d.triangle(a, c, 270, e, g, f, h, k);
        break;
      case "triangleRight":
        p = d.triangle(a, c, 90, e, g, f, h, k);
        break;
      case "bubble":
        p = d.circle(a, c / 2, e, g,
          f, h, k, !0);
        break;
      case "line":
        p = d.line(a, [-c / 2, c / 2], [0, 0], e, g, f, h, k);
        break;
      case "yError":
        p = a.set();
        p.push(d.line(a, [0, 0], [-c / 2, c / 2], e, g, f));
        p.push(d.line(a, [-l, l], [-c / 2, -c / 2], e, g, f));
        p.push(d.line(a, [-l, l], [c / 2, c / 2], e, g, f));
        break;
      case "xError":
        p = a.set(), p.push(d.line(a, [-c / 2, c / 2], [0, 0], e, g, f)), p.push(d.line(a, [-c / 2, -c / 2], [-l, l], e, g, f)), p.push(d.line(a, [c / 2, c / 2], [-l, l], e, g, f))
    }
    p && p.pattern(n, NaN, r);
    return p
  };
  ...
  d.makeHD = function (a, b, c) {
    for (var e = [], d = [], f = 1; f < a.length; f++)for (var h = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]),
                                                             n = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - h) / n, m = (m - k) / n, r = 0; r <= n; r++) {
      var v = k + r * m + Math.random() * c;
      e.push(h + r * l + Math.random() * c);
      d.push(v)
    }
    return [e, d]
  };
  d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
    var n, r = a.set();
    for (n = 1; n < b.length; n++)for (var v = [b[n - 1], b[n]], p = [c[n - 1], c[n]], p = d.makeHD(v, p, a.handDrawScatter), v = p[0], p = p[1], q = 1; q < v.length; q++)r.push(d.line(a, [v[q - 1], v[q]], [p[q - 1], p[q]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
    return r
  };
  d.doNothing =
    function (a) {
  ...
  d.drop = function (a, b, c, e, d, f, h, k) {
    var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, r = Math.cos(m * l) * b, v = Math.sin((m + 40) * l) * b, p = Math.cos((m + 40) * l) * b, q = .8 * b, x = -b / 3, B = b / 3;
    0 === c && (x = -x, B = 0);
    180 == c && (B = 0);
    90 == c && (x = 0);
    270 == c && (x = 0, B = -B);
    c = {fill: e, stroke: h, "stroke-width": f, "stroke-opacity": k, "fill-opacity": d};
    b = "M" + n + "," + r + " A" + b + "," + b + ",0,1,1," + v + "," + p + (" A" + q + "," + q + ",0,0,0," + (Math.sin((m + 20) * l) * b + B) + "," + (Math.cos((m + 20) * l) * b + x));
    b += " A" + q + "," + q + ",0,0,0," + n + "," + r;
  ...
  d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, r, v, p) {
    ...
    h = q(h);
    k = q(k);
    var x = q(h / f * k), B = d.VML, y = 359.5 + f / 100;
    359.94 < y && (y = 359.94);
    g >= y && (g = y);
    var A = 1 / 180 * Math.PI, y = b + Math.sin(e * A) * k, w = c - Math.cos(e * A) * x, z = b + Math.sin(e * A) * f, D = c - Math.cos(e * A) * h, t = b + Math.sin((e + g) * A) * f, u = c - Math.cos((e + g) * A) * h, E = b + Math.sin((e + g) * A) * k, A = c - Math.cos((e + g) * A) * x, F = {
    ...
    e = a.set();
    var C;
    B && (y = q(10 * y), z = q(10 * z), t = q(10 * t), E = q(10 * E), w = q(10 * w), D = q(10 * D), u = q(10 * u), A = q(10 * A), b = q(10 * b), l = q(10 * l), c = q(10 * c), f *= 10, h *= 10, k *= 10, x *= 10, 1 > Math.abs(g) && 1 >= Math.abs(t - z) && 1 >= Math.abs(u - D) && (C = !0));
    g = "";
    var I;
    r && (F["fill-opacity"] = 0, F["stroke-opacity"] = m["stroke-opacity"] / 2, F.stroke = m.stroke);
    if (0 < l) {
      I = " M" + y + "," + (w + l) + " L" + z + "," + (D + l);
      B ? (C || (I += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + z + "," + (D + l) + "," + t + "," + (u + l)), I += " L" + E + "," + (A + l), 0 < k && (C || (I += " B" + (b - k) + "," + (l + c - x) + "," + (b + k) + "," +
        (l + c + x) + "," + E + "," + (l + A) + "," + y + "," + (l + w)))) : (I += " A" + f + "," + h + ",0," + G + ",1," + t + "," + (u + l) + " L" + E + "," + (A + l), 0 < k && (I += " A" + k + "," + x + ",0," + G + ",0," + y + "," + (w + l)));
      I += " Z";
      var K = l;
      B && (K /= 10);
      for (var J = 0; J < K; J += 10) {
        var L = a.path(I, void 0, void 0, "1000,1000").attr(F);
        e.push(L);
        L.translate(0, -J)
      }
      I = a.path(" M" + y + "," + w + " L" + y + "," + (w + l) + " L" + z + "," + (D + l) + " L" + z + "," + D + " L" + y + "," + w + " Z", void 0, void 0, "1000,1000").attr(F);
      l = a.path(" M" + t + "," + u + " L" + t + "," + (u + l) + " L" + E + "," + (A + l) + " L" + E + "," + A + " L" + t + "," + u + " Z", void 0, void 0,
        "1000,1000").attr(F);
      e.push(I);
      e.push(l)
    }
    B ? (C || (g = " A" + q(b - f) + "," + q(c - h) + "," + q(b + f) + "," + q(c + h) + "," + q(z) + "," + q(D) + "," + q(t) + "," + q(u)), h = " M" + q(y) + "," + q(w) + " L" + q(z) + "," + q(D) + g + " L" + q(E) + "," + q(A)) : h = " M" + y + "," + w + " L" + z + "," + D + (" A" + f + "," + h + ",0," + G + ",1," + t + "," + u) + " L" + E + "," + A;
    0 < k && (B ? C || (h += " B" + (b - k) + "," + (c - x) + "," + (b + k) + "," + (c + x) + "," + E + "," + A + "," + y + "," + w) : h += " A" + k + "," + x + ",0," + G + ",0," + y + "," + w);
    a.handDrawn && (k = d.line(a, [y, z], [w, D], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
      e.push(k));
    k = a.path(h + " Z", void 0, void 0, "1000,1000").attr(m);
    if (n) {
      x = [];
      for (B = 0; B < n.length; B++)x.push(d.adjustLuminosity(m.fill, n[B]));
      "radial" != p || d.isModern || (x = []);
      0 < x.length && k.gradient(p + "Gradient", x)
    }
    d.isModern && "radial" == p && k.grad && (k.grad.setAttribute("gradientUnits", "userSpaceOnUse"), k.grad.setAttribute("r", f), k.grad.setAttribute("gradientTransform", "translate(" + (b - a.width / 2) + "," + (c - a.height / 2) + ")"));
    k.pattern(r, NaN, v);
    e.wedge = k;
    e.push(k);
    return e
  ...
  d.AmLegend = d.Class({
    construct: function (a) {
      ...
      var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, g = this.marginBottom, f = this.horizontalGap,
        h = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, r = k - c - b, v = 0, p = 0, q = this.container;
      this.set && this.set.remove();
      var x = q.set();
      this.set = x;
      var B = q.set();
      x.push(B);
      var y = this.entries, A, w;
      ...
      var z = p = 0, D = f, t = 0, u = 0;
      for (w = 0; w < y.length; w++) {
        var E = y[w];
        this.reversedOrder && (E = y[y.length - w - 1]);
        A = E.getBBox();
        var F;
        this.equalWidths ? F = z * (v + n + this.markerLabelGap) : (F = D, D = D + A.width + f + n);
        A.height > u && (u =
          A.height);
        F + A.width > r && 0 < w && 0 !== z && (p++, F = z = 0, D = F + A.width + f + n, t = t + u + m, u = 0);
        E.translate(F, t);
        z++;
        !isNaN(l) && z >= l && (z = 0, p++, t = t + u + m, D = f, u = 0);
        B.push(E)
      }
      A = B.getBBox();
      l = A.height + 2 * m - 1;
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        var l = this.container, m = this.markerSize, n = 0, r = 0, v = m / 2;
        if (this.useGraphSettings) {
          c = a.type;
          this.switchType = void 0;
          if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)h = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), h.push(n), a.bullet && (a.hidden ||
          (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), h.push(n)), v = 0, n = m, r = m / 3; else {
            var p;
            a.getGradRotation && (p = a.getGradRotation(), 0 === p && (p = 180));
            n = a.fillColorsR;
            !0 === a.hidden && (n = e);
            if (h = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, p, h, a.dashLength))v = m, h.translate(v, m / 2);
            n = m
          }
          d.setCN(b, h, "graph-" + c);
          ...
          m, m); else {
          var q;
          isNaN(this.gradientRotation) || (q = 180 + this.gradientRotation);
        ...
        (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (p = this.createX(), p.translate(m / 2, m / 2)) : p = this.createV(), p.dItem = a, !0 !== a.hidden ? "x" == f ? p.hide() : p.show() :
        "x" != f && p.hide(), this.switchable || p.hide(), this.addListeners(p, a), a.legendSwitch = p, l.push(p), d.setCN(b, p, "legend-switch"));
        f = this.color;
        ...
        p = this.fontSize;
        h && (m <= p && h.translate(v, m / 2 + this.ly - p / 2 + (p + 2 - m) / 2 - r), a.legendEntryWidth = h.getBBox().width);
        var x;
        e && (e = d.fixBrakes(e), a.legendTextReal =
          e, x = this.labelWidth, x = isNaN(x) ? d.text(this.container, e, f, b.fontFamily, p, "start") : d.wrappedText(this.container, e, f, b.fontFamily, p, "start", !1, x, 0), d.setCN(b, x, "legend-label"), x.translate(this.lx + n, this.ly), l.push(x), b = x.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        c = b.container.rect(a.legendEntryWidth,
          0, f, e, 0, 0).attr({stroke: "none", fill: "#fff", "fill-opacity": .005});
        c.dItem = a;
      ...
      var a = (this.markerSize - 4) / 2, b = {
          ...
          "stroke-width": 3
        }, c = this.container, e = d.line(c, [-a, a], [-a, a]).attr(b),
...
(function () {
  ...
  d.AmMap = d.Class({
    inherits: d.AmChart, construct: function (a) {
      ...
      for (c = 0; c < b.length; c++)e = b[c], e.imageLabel && this.imagesProcessor.positionLabel(e.imageLabel,
        e, e.labelPositionReal);
      ...
      this.balloon.hide(0);
      a && this.mouseIsOver && a.preventDefault && this.panEventsEnabled &&
      a.preventDefault();
      if (this.chartCreated && !this.preventHover && (this.initialTouchZoom = this.zoomLevel(), this.dragMap && (this.stopAnimation(), this.mapContainerClickX = this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
        ...
        e && this.panEventsEnabled && this.boundingRect && (a = e.clientX - this.boundingRect.left, e = e.clientY - this.boundingRect.top, this.middleXP = (b + (a -
      ...
      if (d.isModern) {
        ...
        if (!a.preventHover) {
          ...
          isNaN(c) || isNaN(e) || !(2 < Math.abs(b.x - c) ||
          Math.abs(b.y - e)) || (a.mapWasDragged = !0, b = {
            type: "dragCompleted",
            zoomX: a.zoomX(),
            zoomY: a.zoomY(),
          ...
          a.zoomOnDoubleClick && a.mouseIsOver && (b = (new Date).getTime(), 200 > b - a.previousClickTime && 40 < b - a.previousClickTime && a.doDoubleClickZoom(),
      ...
      if (!a || !a.touches || !b.tapToActivate || b.tapped) {
        ...
        b.mouse2X = NaN;
        b.mouse2Y = NaN;
        a && a.touches && (a = a.touches.item(1)) && b.panEventsEnabled && b.boundingRect && (b.mouse2X =
          a.clientX - b.boundingRect.left, b.mouse2Y = a.clientY - b.boundingRect.top);
        if (a = b.mapContainer) {
          ...
          var m = b.realHeight, n = b.realWidth, r = b.mapWidth, v = b.mapHeight;
          ...
          if (!isNaN(k)) {
            ...
            isNaN(q) &&
            (q = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2)));
            if (!isNaN(q)) {
              var k = b.initialTouchZoom * p / q, k = d.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel), h = b.zoomLevel(), q = b.middleXP, l = b.middleYP, p = m / v, x = n / r, q = (b.zoomX() - q * x) * (k / h) + q * x, l = (b.zoomY() - l * p) * (k / h) + l * p;
              .1 < Math.abs(k - h) && (b.zoomTo(k, q, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
            }
          }
          k = a.scale;
          b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (g - c), e = a.y + (f - e), b.preventDragOut && (v = -v * k + m / 2, m /= 2, c = d.fitToBounds(c, -r * k + n / 2, n / 2), e = d.fitToBounds(e,
            v, m)), a.translate(c, e, k, !0), b.updateSmallMap());
          b.previuosMouseX = g;
          b.previuosMouseY = f
        }
      }
      ...
      c.selectedObject = a;
      var f = !1, h, k;
      "MapArea" == a.objectType && (a.autoZoomReal && (f = !0), h = c.areasSettings.selectedOutlineColor,
      ...
      if (b) {
        ...
        if ("MapLine" == a.objectType) {
          ...
          if (d = a.arrowSvg)d.setAttr("fill",
            c), d.setAttr("stroke", c)
        }
        var d = a.alphaReal, g = a.outlineAlphaReal, f = a.outlineThicknessReal, h = a.outlineColorReal;
        if (a.showAsSelected) {
        ...
        if (k = a.image)k.setAttr("fill",
          c), k.setAttr("stroke", h), k.setAttr("stroke-width", f), k.setAttr("fill-opacity", d), k.setAttr("stroke-opacity", g);
        "MapArea" == a.objectType && (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel()), b.setAttr("stroke", h), b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", d), b.setAttr("stroke-opacity", g));
        (c = a.pattern) && b.pattern(c, this.mapScale, this.path);
        (b = a.imageLabel) && !a.labelInactive && (a.showAsSelected && void 0 !== a.selectedLabelColor ? b.setAttr("fill", a.selectedLabelColor) : b.setAttr("fill",
          a.labelColorReal))
      }
      ...
      if (!this.objectWasClicked) {
        ...
        b = this.coordinateToLongitude((b - this.mapContainer.x) / g);
    ...
    zoomToLongLat: function (a, b, c, d) {
      ...
      if (a) {
        ...
        "MapArea" == a.objectType && (f = a.displayObject.getBBox(), b = this.mapScale, c = f.x * b, e = f.y * b, g = f.width * b, f = f.height * b, k = a.autoZoomReal && isNaN(a.zoomLevel) ? g / k > f / l ? .8 * k / g : .8 * l / f : a.zoomLevel, l = this.zoomControl, k = d.fitToBounds(k, l.minZoomLevel, l.maxZoomLevel), isNaN(a.zoomX) && isNaN(a.zoomY) &&
        isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && (a = this.mapSet.getBBox(), this.zoomToMapXY(k, -a.x * b + c + g / 2, -a.y * b + e + f / 2)));
      ...
      if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length || a == this.dataProvider) {
        ...
        a && (this.imagesProcessor.reset(), this.linesProcessor.reset(), this.linesAboveImages ? (this.imagesProcessor.process(a), this.linesProcessor.process(a)) : (this.linesProcessor.process(a),
      ...
      var d;
      for (d = 0; d < a.length; d++) {
        var g = a[d], f = g.d, h = g.title;
        g.titleTr && (h = g.titleTr);
        f = b.path(f);
        f.id = g.id;
        if (this.areasSettings.preserveOriginalAttributes) {
          f.customAttr = {};
          for (var k in g)"d" != k && "id" != k && "title" != k && (f.customAttr[k] = g[k])
        }
      ...
      if (!a.showAsSelected && b && !a.isOver) {
        ...
        void 0 == c && (isNaN(a.rollOverBrightnessReal) || (c = d.adjustLuminosity(a.colorReal, a.rollOverBrightnessReal /
          100)));
        ...
        (e = a.image) && (isNaN(c) || e.setAttr("stroke-width", c))) : (c = this.areasSettings.rollOverOutlineThickness, isNaN(c) || b.setAttr("stroke-width", c));
    ...
    rollOutMapObject: function (a, b) {
      this.hideBalloon();
      this.chartCreated && a.isOver && (this.checkIfSelected(a) || this.returnInitialColor(a), this.fire({
      ...
      if (c.chartCreated && !c.preventHover && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
        ...
        c.clickLongitude = c.coordinateToLongitude((c.mouseX -
          c.mapContainer.x) / d);
    ...
    getBounds: function () {
      ...
      if (this.mapSet) {
        ...
        b = this.mapHeight;
        "mercator" == c.projection ? (c = this.mercatorLatitudeToCoordinate(e), g = this.mercatorLatitudeToCoordinate(g), b = d.radiansToDegrees(2 * Math.atan(Math.exp(2 *
      ...
      if (c) {
        ...
        for (g = 0; g < k; g++) {
          ...
          if (0 !==
            f.childNodes.length || "" !== m || !1 !== n)if (3 == f.nodeType || 4 == f.nodeType) {
            if ("" !== m) {
              f = 0;
      ...
      if (a) {
        ...
        for (e = 0; e < a.length; e++) {
          ...
          a[e] = g;
          g.areas && this.processObject(g.areas,
            g, "area");
  ...
  d.ZoomControl = d.Class({
    construct: function (a) {
      ...
      var g = c.buttonSize, f = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor, l = c.buttonFillAlpha, m = c.buttonBorderThickness,
        n = c.buttonBorderColor, r = c.buttonBorderAlpha, v = c.buttonCornerRadius, p = c.buttonRollOverColor, q = c.gridHeight, x = c.zoomFactor, B = c.minZoomLevel, y = c.maxZoomLevel, A = c.buttonIconAlpha, w = c.buttonIconColor, z = c.roundButtons, D = a.svgIcons, t = a.getX(c.left), u = a.getY(c.top);
      isNaN(c.right) || (t = a.getX(c.right, !0), t = h ? t - 3 * g : t - g);
      isNaN(c.bottom) || (u = a.getY(c.bottom, !0), f && (u -= q + 3 * g), u = h ? u - 3 * g : c.homeButtonEnabled ? u - .5 * g : u + g);
      e.translate(t, u);
      c.previousDY = NaN;
      var E, t = g / 4 - 1;
      if (f) {
        ...
        z && (F = g / 1.5);
        c.draggerSize = F;
        var G = Math.log(y / B) / Math.log(x) + 1;
        1E3 < G && (G = 1E3);
        var f = q / G, C, I = b.set();
        I.translate((g - F) / 2 + 1, 1, NaN, !0);
        E.push(I);
        for (C = 1; C < G; C++)u = g + C * f, u = d.line(b, [1, F - 2], [u, u], c.gridColor, c.gridAlpha, 1), d.setCN(a, u, "zoom-grid"), I.push(u);
        u = new d.SimpleButton;
        u.setDownHandler(c.draggerDown, c);
        u.setClickHandler(c.draggerUp, c);
        u.init(b, F, f, k, l, m, n, r, v, p);
        d.setCN(a, u.set, "zoom-dragger");
        E.push(u.set);
        u.set.setAttr("opacity", c.draggerAlpha);
        c.dragger = u.set;
        c.previousY = NaN;
        u = new d.SimpleButton;
        D ? (F = b.set(), G = d.line(b, [-t, t], [0, 0], w, A, 1), C = d.line(b, [0, 0], [-t, t], w, A, 1), F.push(G), F.push(C), u.svgIcon = F) : u.setIcon(a.pathToImages + "plus.gif", c.iconSize);
        u.setClickHandler(a.zoomIn, a);
        u.init(b, g, g, k, l, m, n, r, v, p, A, w, z);
        d.setCN(a, u.set, "zoom-in");
        E.push(u.set);
        u = new d.SimpleButton;
        D ? u.svgIcon = d.line(b, [-t, t], [0, 0], w, A, 1) : u.setIcon(a.pathToImages + "minus.gif", c.iconSize);
        u.setClickHandler(a.zoomOut, a);
        u.init(b, g, g, k, l, m, n, r, v, p, A, w, z);
        u.set.translate(0, q + g);
        d.setCN(a, u.set, "zoom-out");
        E.push(u.set);
        q -= f;
        y = Math.log(y / 100) / Math.log(x);
        c.realStepSize = q / (y - Math.log(B / 100) / Math.log(x));
        c.realGridHeight = q;
        c.stepMax = y
      }
      h && (h = b.set(), d.setCN(a, h, "zoom-control-pan"), e.push(h), E && E.translate(g, 4 * g), x = new d.SimpleButton, D ? x.svgIcon = d.line(b, [t / 5, -t + t / 5, t / 5], [-t, 0, t], w, A, 1) : x.setIcon(a.pathToImages +
        "panLeft.gif", c.iconSize), x.setClickHandler(a.moveLeft, a), x.init(b, g, g, k, l, m, n, r, v, p, A, w, z), x.set.translate(0, g), d.setCN(a, x.set, "pan-left"), h.push(x.set), x = new d.SimpleButton, D ? x.svgIcon = d.line(b, [-t / 5, t - t / 5, -t / 5], [-t, 0, t], w, A, 1) : x.setIcon(a.pathToImages + "panRight.gif", c.iconSize), x.setClickHandler(a.moveRight, a), x.init(b, g, g, k, l, m, n, r, v, p, A, w, z), x.set.translate(2 * g, g), d.setCN(a, x.set, "pan-right"), h.push(x.set), x = new d.SimpleButton, D ? x.svgIcon = d.line(b, [-t, 0, t], [t / 5, -t + t / 5, t / 5], w, A, 1) : x.setIcon(a.pathToImages +
        "panUp.gif", c.iconSize), x.setClickHandler(a.moveUp, a), x.init(b, g, g, k, l, m, n, r, v, p, A, w, z), x.set.translate(g, 0), d.setCN(a, x.set, "pan-up"), h.push(x.set), x = new d.SimpleButton, D ? x.svgIcon = d.line(b, [-t, 0, t], [-t / 5, t - t / 5, -t / 5], w, A, 1) : x.setIcon(a.pathToImages + "panDown.gif", c.iconSize), x.setClickHandler(a.moveDown, a), x.init(b, g, g, k, l, m, n, r, v, p, A, w, z), x.set.translate(g, 2 * g), d.setCN(a, x.set, "pan-down"), h.push(x.set), e.push(h));
      c.homeButtonEnabled && (h = new d.SimpleButton, D ? h.svgIcon = d.polygon(b, [-t, 0, t, t - 1, t - 1,
        2, 2, -2, -2, -t + 1, -t + 1], [0, -t, 0, 0, t - 1, t - 1, 2, 2, t - 1, t - 1, 0], w, A, 1, w, A) : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), h.setClickHandler(a.goHome, a), c.panControlEnabled && (r = l = 0), h.init(b, g, g, k, l, m, n, r, v, p, A, w, z), c.panControlEnabled ? h.set.translate(g, g) : E && E.translate(0, 1.5 * g), d.setCN(a, h.set, "pan-home"), e.push(h.set));
      c.update()
      ...
      var a = this.chart;
      a.zoomTo(100 * Math.pow(this.zoomFactor,
      ...
      h && (this.isDragging ? (h.stopDrag(), f = e.y + (h.mouseY - this.previousY), f = d.fitToBounds(f, g, this.realGridHeight + g), h.zoomTo(100 * Math.pow(a, c - (f - g) / b), NaN, NaN, !0)) : (a = Math.log(h.zoomLevel() / 100) / Math.log(a), f = (c - a) * b + g), this.previousY = h.mouseY, this.previousDY != f && e && (e.translate((this.buttonSize -
        this.draggerSize) / 2, f), this.previousDY = f))
    }
  })
})();
(function () {
  ...
  d.SimpleButton = d.Class({
    construct: function () {
    }, init: function (a, b, c, e, g, f, h, k, l, m, n, r, v) {
      var p = this;
      p.rollOverColor = m;
      p.color = e;
      p.container = a;
      m = a.set();
      p.set = m;
      v ? (b /= 2, e = d.circle(a, b, e, g, f, h, k), e.translate(b, b)) : e = d.rect(a, b, c, e, g, f, h, k, l);
      m.push(e);
      g = p.iconPath;
      var q;
      g && (q = p.iconSize, f = (b - q) / 2, v && (f = (2 * b - q) / 2), q = a.image(g, f, (c - q) / 2, q, q));
      p.svgIcon && (q = p.svgIcon, v ? q.translate(b, b) : q.translate(b / 2, b / 2));
  ...
  d.SmallMap = d.Class({
    construct: function (a) {
      ...
      if (c.enabled) {
        ...
        c.downButtonSet = n;
        e.push(n);
        var v = new d.SimpleButton;
        a.svgIcons ? v.svgIcon = d.line(b, [-r / 2, 0, r / 2], [r / 4, -r / 4, r / 4], c.iconColor, 1, 1) : v.setIcon(a.pathToImages + "arrowUp.gif", k);
        v.setClickHandler(c.maximize, c);
        v.init(b, k, k, h, 1, 1, h, 1);
        d.setCN(a, v.set, "small-map-up");
        h = v.set;
        c.upButtonSet = h;
        h.hide();
        e.push(h);
    ...
    construct: function (a) {
      ...
      for (n = 0; n < h.length; n++) {
        ...
        if (b.preserveOriginalAttributes) {
          ...
          l.setAttr("stroke-width", v)
        }
        d.setCN(a, l, "map-area-unlisted");
        k.getAreasFromMap && !m[l.id] && (v = new d.MapArea(a.theme), v.parentObject = k, v.id = l.id, k.areas.push(v))
      }
      ...
      var f = e.color, h = e.alpha, k = e.outlineThickness, l = e.rollOverColor, m = e.selectedColor, n = e.rollOverAlpha, r = e.rollOverBrightness, v = e.outlineColor, p = e.outlineAlpha, q = e.balloonText, x = e.selectable, B = e.pattern, y = e.rollOverOutlineColor, A = e.bringForwardOnHover, w = e.preserveOriginalAttributes;
      ...
      if (c && (r = c.area, A = c.title, a.enTitle = c.title, A && !a.title && (a.title = A), (c = b.language) ? (A = d.mapTranslations) && (c = A[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, r)) {
        ...
        void 0 != g && (D = g);
        void 0 != a.colorReal &&
        (D = a.showAsSelected || b.selectedObject == a ? a.selectedColorReal : a.colorReal);
        r.node.setAttribute("class", "");
        d.setCN(b, r, "map-area");
        d.setCN(b, r, "map-area-" + r.id);
        e.adjustOutlineThickness && (p /= b.zoomLevel());
        a.preserveOriginalAttributes || (r.setAttr("fill", D), r.setAttr("stroke", f), r.setAttr("stroke-opacity", v), r.setAttr("stroke-width", p), r.setAttr("fill-opacity", z));
...
(function () {
  ...
  d.ImagesProcessor = d.Class({
    construct: function (a) {
      ...
      a.remove &&
      a.remove();
      var k = h.color, l = h.alpha, m = h.rollOverColor, n = h.rollOverOutlineColor, r = h.selectedColor, v = h.balloonText, p = h.outlineColor, q = h.outlineAlpha, x = h.outlineThickness, B = h.selectedScale, y = h.rollOverScale, A = h.labelPosition, w = h.labelColor, z = h.labelFontSize, D = h.bringForwardOnHover, t = h.labelRollOverColor, u = h.rollOverBrightness, E = h.selectedLabelColor;
      a.index = b;
      a.chart = c;
      ...
      q = a.height;
      n = a.scale;
      isNaN(a.percentWidth) || (E = a.percentWidth / 100 * c.realWidth);
      isNaN(a.percentHeight) || (q = a.percentHeight / 100 * c.realHeight);
      var C;
      B || y || z || (y = "circle", E = 1, l = k = 0);
      t = u = 0;
      h = a.selectedColorReal;
      if (y) {
        isNaN(E) && (E = 10);
        isNaN(q) && (q = 10);
        "kilometers" == a.widthAndHeightUnits && (E = c.kilometersToPixels(a.width), q = c.kilometersToPixels(a.height));
        "miles" == a.widthAndHeightUnits && (E = c.milesToPixels(a.width), q = c.milesToPixels(a.height));
        if ("circle" == y || "bubble" ==
          y)q = E;
        C = this.createPredefinedImage(G, v, p, y, E, q);
        t = u = 0;
        a.centeredReal ? (isNaN(a.right) || (u = E * n), isNaN(a.bottom) || (t = q * n)) : (u = E * n / 2, t = q * n / 2);
        C.translate(u, t, n, !0)
        ...
        2, isNaN(a.bottom) || (t = -t)) : u = t = 0, C.translate(u, t, n, !0), C.x = u, C.y = t);
      C && (F.push(C), a.image = C, C.setAttr("stroke-opacity", l), C.setAttr("stroke-width", p), C.setAttr("stroke", v), C.setAttr("fill-opacity", k), C.setAttr("fill", G), d.setCN(c, C, "map-image"), void 0 != a.id && d.setCN(c, C, "map-image-" + a.id));
      G = a.labelColorReal;
      !a.showAsSelected && c.selectedObject != a || void 0 == h || (C.setAttr("fill", h), G = a.selectedLabelColorReal);
      C = null;
      void 0 !== a.label && (C = d.text(e, a.label, G, c.fontFamily, a.labelFontSizeReal, a.labelAlign),
        d.setCN(c, C, "map-image-label"), void 0 !== a.id && d.setCN(c, C, "map-image-label-" + a.id), G = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) && 0 < G && (l = C.getBBox(), e = d.rect(e, l.width + 16, l.height + 10, k, G), d.setCN(c, e, "map-image-label-background"), void 0 != a.id && d.setCN(c, e, "map-image-label-background-" + a.id), F.push(e), a.labelBG = e), a.imageLabel = C, F.push(C), d.setCN(c, F, "map-image-container"), void 0 != a.id && d.setCN(c, F, "map-image-container-" + a.id));
      e = isNaN(a.latitude) || isNaN(a.longitude) ? !0 : !1;
      a.lineId && (C = this.chart.getObjectById(a.lineId)) &&
      0 < C.longitudes.length && (e = !1);
      e ? f.push(F) : g.push(F);
      F && (F.rotation = a.rotation, isNaN(a.rotation) || F.rotate(a.rotation));
      this.updateSizeAndPosition(a);
      a.mouseEnabled && c.addObjectEventListeners(F, a);
      a.hidden && F.hide();
      ...
      isNaN(a.bottom) || (g = b.getY(a.bottom,
          !0) - h.height * a.scale);
      ...
      if (a.lineId) {
        var v = this.chart.getObjectById(a.lineId);
        (a.line = v) && v.getCoordinates && (v.chart = b, v = v.getCoordinates(m, a.lineSegment)) && (k = b.coordinateToLongitude(v.x), l = b.coordinateToLatitude(v.y), f = d.radiansToDegrees(v.angle))
      }
      isNaN(f) ||
      c.rotate(f + a.extraAngle);
      ...
      if (a) {
        ...
        b.labelBG && b.labelBG.translate(g - d.width / 2 + b.labelShiftX - 9,
  ...
  d.LinesProcessor = d.Class({
    construct: function (a) {
      ...
      var c = this.chart, e = c.linesSettings, g = this.objectsToResize, f = c.mapLinesContainer,
        h = c.stageLinesContainer, k = e.thickness, l = e.dashLength, m = e.arrow, n = e.arrowSize, r = e.arrowColor, v = e.arrowAlpha, p = e.color, q = e.alpha, x = e.rollOverColor, B = e.selectedColor, y = e.rollOverAlpha, A = e.balloonText, w = e.bringForwardOnHover, z = e.arc, D = e.rollOverBrightness, t = c.container;
      a.chart = c;
      a.baseSettings = e;
      var u = t.set();
      a.displayObject = u;
      this.allSvgObjects.push(u);
      a.arrays.push({arr: this.allSvgObjects, el: u});
      this.allObjects.push(a);
      a.arrays.push({arr: this.allObjects, el: a});
      a.mouseEnabled && c.addObjectEventListeners(u,
        a);
      if (a.remainVisible || c.selectedObject == a.parentObject) {
        ...
        e = a.latitudes;
        q = n.length;
        if (0 < q)for (w = [], y = 0; y < q; y++)w.push(c.longitudeToCoordinate(n[y]));
        q = e.length;
        if (0 < q)for (D = [], y = 0; y < q; y++)D.push(c.latitudeToCoordinate(e[y]));
        if (0 < w.length) {
          a.segments = w.length;
          d.dx = 0;
          d.dy = 0;
          var F, G, C, n = 10 * (1 - Math.abs(A));
          10 <= n && (n = NaN);
          1 > n && (n = 1);
          a.arcRadius = [];
          a.distances = [];
          if (isNaN(n)) {
            for (n = 0; n < w.length - 1; n++)G = Math.sqrt(Math.pow(w[n + 1] - w[n], 2) + Math.pow(D[n + 1] - D[n], 2)), a.distances[n] = G;
            n = d.line(t, w, D, l, 1, E, k, !1, !1, !0);
            l = d.line(t, w, D, l, .001, 5, k, !1, !1, !0)
          } else {
            q = 1;
            0 > A && (q = 0);
            y = {
            ...
            void 0 !== k && 0 < k && (y["stroke-dasharray"] = k);
            k = "";
            for (B = 0; B < w.length - 1; B++) {
              var I = w[B], K = w[B + 1], J = D[B], L = D[B + 1];
              G = Math.sqrt(Math.pow(K - I, 2) + Math.pow(L - J, 2));
              C = G / 2 * n;
              F = 270 + 180 * Math.acos(G / 2 / C) / Math.PI;
              isNaN(F) && (F = 270);
              if (I < K) {
                var O = I, I = K, K = O, O = J, J = L, L = O;
                F = -F
              }
              0 < A && (F = -F);
              k += "M" + I + "," + J + "A" + C + "," + C + ",0,0," + q + "," + K + "," + L;
              a.arcRadius[B] = C;
              a.distances[B] = G
            }
            n = t.path(k).attr(y);
          ...
          if ("none" != z) {
            var H, M, N;
            if ("end" == z || "both" == z)p = w[w.length - 1], q = D[D.length - 1], 1 < w.length ? (k = w[w.length - 2], H = D[D.length - 2]) : (k = p, H = q), H = 180 * Math.atan((q - H) / (p - k)) / Math.PI, isNaN(F) || (H += F), M = p, N = q, H = 0 > p - k ? H - 90 : H + 90;
            "both" == z && (p = d.polygon(t, [-v / 2, 0, v / 2], [1.5 * v, 0, 1.5 * v], m, r, 1, m, r), u.push(p), p.translate(M, N, 1, !0), isNaN(H) || p.rotate(H), d.setCN(c, n, "map-line-arrow"),
            void 0 != a.id && d.setCN(c, n, "map-line-arrow-" + a.id), a.fixedSize && g.push(p));
            if ("start" == z || "both" == z)p = w[0], N = D[0], 1 < w.length ? (k = w[1], M = D[1]) : (k = p, M = N), H = 180 * Math.atan((N - M) / (p - k)) / Math.PI, isNaN(F) || (H -= F), M = p, H = 0 > p - k ? H - 90 : H + 90;
            "middle" == z && (p = w[w.length - 1], q = D[D.length - 1], 1 < w.length ? (k = w[w.length - 2], H = D[D.length - 2]) : (k = p, H = q), M = k + (p - k) / 2, N = H + (q - H) / 2, H = 180 * Math.atan((q - H) / (p - k)) / Math.PI, isNaN(F) || (F = G / 2, C -= Math.sqrt(C * C - F * F), 0 > A && (C = -C), F = Math.sin(H / 180 * Math.PI), -1 == F && (F = 1), M -= F * C, N += Math.cos(H / 180 *
                Math.PI) * C), H = 0 > p - k ? H - 90 : H + 90);
            p = d.polygon(t, [-v / 2, 0, v / 2], [1.5 * v, 0, 1.5 * v], m, r, 1, m, r);
          ...
          a.fixedSize && n && (c = {
            ...
            line: l,
            thickness: 5
          }, this.linesToResize.push(c), a.arrays.push({arr: this.linesToResize, el: c}));
          a.lineSvg =
            n;
          a.showAsSelected && !isNaN(x) && n.setAttr("stroke", x);
          0 < e.length ? f.push(u) : h.push(u);
          a.hidden && u.hide()
        }
      }
    ...
    inherits: d.MapObject, construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        if (!isNaN(this.arc) && this.arcRadius) {
          ...
          var r = e + (f - e) / 2 + Math.sqrt(k * k - l / 2 * (l / 2)) * (g - c) / l;
          c = 180 * Math.atan2(e - r, c - h) / Math.PI;
          m = d.degreesToRadians(c + (180 * Math.atan2(f - r, g - h) / Math.PI - c) * a);
          h += k * Math.cos(m);
          k = r + k * Math.sin(m);
...
(function () {
  ...
  d.MapImage = d.Class({
    ...
    remove: function () {
      ...
      c = 1;
      a.line && b.adjustAnimationSpeed && (a.line.distances && (c = a.line.distances[a.lineSegment] * a.chart.zoomLevel(), c = Math.abs(c / b.baseAnimationDistance)), a.totalFrames = Math.round(c *
        a.totalFrames));
      a.frame = 0;
      a.clearTO();
      ...
      a.frame++;
      c = a.totalFrames;
      a.frame <= c ? (e = e(0, a.frame, 0, 1, c), -1 == a.direction && (e =
      ...
      isNaN(this.top) ||
      (this.latitude = this.chart.stageYToLatitude(this.top), this.top = void 0);
      this.validate()
    }
  })
})();
