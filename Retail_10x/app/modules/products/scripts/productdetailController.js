...
angular.module('productDetail.controllers',
  ...
  .controller('productDetailCtrl', ['$scope', '$state', 'serviceFactory','productService','dashBoardService','$http','$timeout','usSpinnerService', '$rootScope','$filter',
    ...
    if (sessionStorage.user == undefined || sessionStorage.user == null||sessionStorage.user =="null") {
      $state.go('login');
        ...
        // $scope.departmentDetail=productService.getdeptDetail();
         //console.log("departmentDetail",$scope.departmentDetail);

     //..........get product data here......   
     $scope.productdetail.push(productService.getproductdetail());
      ...
      $scope.departmentDetail=productService.getdeptDetail();
       /* productService.DeptDataforRetailer().then(function (response) {
          console.log("DeptDataforretailer",response.data[0]);
           $scope.departmentDetail=response.data[0];
        });*/
      }
  ...
  //$scope.departmentdescription=$scope.departmentList[j].departmentDescription;
              ...
              $scope.prdctdetail.push(data);
             productService.setselectedproduct($scope.prdctdetail);
              console.log("prd data",$scope.prdctdetail);
             $state.go('individualDepartment');
            //}
          //}
        }
    ...
    function daterangepickerCallBackreporttimeindividual(start, end,label) {
      $timeout(function() {
        ...
        $scope.reporttime=start.format('MM/DD/YYYY')+" - "+end.format('MM/DD/YYYY');
  ...
  // ..........getstore detail............
          ...
          $scope.makeStoresList=function(retailerid,retailerName,status){
            dashBoardService.storeListforCPG().then(function (response) {
              ...
              for(var j=0;j<$scope.storesList.length;j++){
               ...
               //console.log("last retailername...",$scope.retailerData[index]);
               if($scope.retailerData[index].retailer_name==$scope.getStoresData[i].retailername){
                  $timeout(function(){
                     ...
                     for(var i=0;i<$scope.retailerData.length;i++){
                        ...
                        //console.log("retailer name....",$scope.retailerData[i].retailer_name);
                        //console.log("find retailer...",findretailer);
                    ...
                    // console.log("all the list....",$scope.ctrl.treeData);
                  },1400)
                }
              }
             }, function (response) {
   ...
   console.log("retailerIds...",$scope.retailerData);
  ...
  // ...............compare product...........
    ...
    if($scope.role=="retailer"){
        ...
        //console.log("category123356567", $scope.category, " ", $scope.optionid );
      ...
      $scope.categoryalreadyselected=productService.getselectedCategory();
       console.log(" $scope.categoryalreadyselected", $scope.categoryalreadyselected);
      ...
      // $scope.categoryalreadyselected=window.localStorage['categoryselected'];
       $scope.categoryalreadyselected=productService.getselectedCategory();
        // if($scope.categoryalreadyselected!=""&&$scope.categoryalreadyselected!=undefined){
            ...
            //console.log("$scope.selectedBrand",$scope.BrandIdsList);
            $scope.onlycategory= window.localStorage['onlycategory'];
            if($scope.onlycategory=="true"){
    ...
    $scope.subproductList = function (deptid, category) {
      ...
      //console.log("dfhfgnhj",$scope.ReportstartDate);
           ...
           $scope.individualproductflag= window.localStorage['individualProduct']
            if($scope.flagcheck=='screen3'){
                if($scope.productdetail== null){
                    ...
                    $scope.selectedProduct($scope.productdetail[0]);
                }
            }
    ...
    // compare product for distributer............
 ...
 $scope.deptmentid;
    ...
    $scope.subproductListbyDistributor= function (deptid,brandList) {
       ...
       productService.getitemsbycategory($scope.getdata).then(function (response) {
          ...
          if(response.data.data[i].name!=""){
           ...
           if($scope.individualcategoryproduct==true){
               $scope.optionpname=window.localStorage['pname'];
               console.log("optionpname....",$scope.optionpname);
               $scope.option=window.localStorage['selectoption1'];
               $scope.optionid=window.localStorage['iddept'];
               $scope.dataplusmark=window.localStorage['dataplus'];
               $scope.optionpitemNumber=window.localStorage['itemNum'];
	  ...
	  $scope.selectedcompareProduct = function (data) {
        ...
        if(data){         
                 ...
                 for (var i = 0; i < $scope.productList.length; i++) {    
                    if(  $scope.productList[i].itemName == data.itemName){
                         ...
                         $scope.prdctdetail.push($scope.productList[i]);
                        //console.log("$scope.prdctdetail",$scope.prdctdetail);                   
                          productService.setselectedproduct($scope.prdctdetail);
                             $state.go('individualDepartment');
   ...
   $scope.avgBasketFunction = function (upc) {
      $scope.avgBasketByRT = function () {         
        ...
        dashBoardService.GetAvgBasket(ShoppingTripsdataRT).then(function (response) {
           ...
           for(var i=0;i<$scope.itemsList.length;i++){
               if($scope.itemsList[i].itemNumber==upc){
                  $scope.itemsList[i].linechart.avgbasket=$scope.ABtotal;
                  $scope.itemsList[i].barchart.avgbasket=$scope.ABtotal;
                }
            }
         }, function (response) {
            console.log(response);
    ...
    $scope.avgBasketFunctionbystore = function (upc) {
        $scope.avgBasketByRTbystore = function () {
           var ShoppingTripsdataRT = {
             "aggTimeUnit": "1d",
             "startTime":$scope.ReportstartDate,
             "endTime":$scope.Reportenddate,
    ...
    $scope.avgBasketFunctionbystoreforCPG = function (upc) {
    ...
    $scope.ShoppingTripsFunction = function (upc) {
       $scope.ShoppingTripsbyRT = function () {
        ...
        dashBoardService.GetShoppingTrips(ShoppingTripsdataRT).then(function (response){
           ...
           for(var i=0;i<$scope.itemsList.length;i++){
               if($scope.itemsList[i].itemNumber==upc){
                  $scope.itemsList[i].linechart.shoppingtrips=$scope.STIndex;
                  $scope.itemsList[i].barchart.shoppingtrips=$scope.STIndex;
                }
            }
            }, function (response) {
              console.log(response);
    ...
    $scope.ShoppingTripsFunctionbystore = function (upc) {
        $scope.ShoppingTripsbyRTbystore = function () {
            var ShoppingTripsdataRT = {
               "aggTimeUnit": "1d",
               "startTime":$scope.ReportstartDate,
               "endTime":$scope.Reportenddate,
       ...
       var ShoppingTripsdata = {
        ...
        dashBoardService.GetShoppingTripsByStoreId(ShoppingTripsdata).then(function (response) {
           $scope.ShoppingTripsCPindex = parseFloat(response.data.total);
           $scope.ShoppingTripsbyRTbystore();
        }, function (response) {
          console.log(response);
        });
    }
    ...
    $scope.ShoppingTripsFunctionbystoreforCPG = function (upc) {
        $scope.ShoppingTripsbyRTbystore = function () {
            var ShoppingTripsdataRT = {
               "aggTimeUnit": "1d",
               "startTime":$scope.ReportstartDate,
        ...
        productService.GetSalesPerformance(data).then(function (response) {
            ...
            for (var i = 0; i <= days; i++) {
             if(i==0){
                ...
                //console.log("days",days, $scope.date," $scope.ResultDate", $scope.ResultDate);
                ...
                if($scope.ProductsbyCT[i]&&$scope.ProductsbyRT[i]){
                 var linechartdataobject = {
                   ...
                   "value2": $scope.ProductsbyCT[i].amt,
                    ...
                    "RetailRT":  $filter('number')($scope.ProductsbyRT[i].amt / $scope.ProductsbyRT[i].soldQuantity,2),
                     "RetailCT": $filter('number')($scope.ProductsbyCT[i].amt / $scope.ProductsbyCT[i].soldQuantity,2)
                     }
       ...
       console.log("data",data);
        if(data){
            ...
            $scope.getproductBySelectedItemforDistributor($scope.selecteditem,$scope.selectedproductName);
                  ...
                  $scope.selectedcpg=dashBoardService.getsavestoreselected();  
                  $scope.selecteddma=dashBoardService.getselectedDMA();
                    if($scope.selecteddma !== null || $scope.selecteddma != undefined){
                        $scope.dma= $scope.selecteddma.name;
                        $scope.dmaStoreList=[];
                        for(var i=0;i<$scope.selecteddma.stores.length;i++){
                        $scope.dmaStoreList.push($scope.selecteddma.stores[i].toString());
             ...
             $scope.barchartapicallstatus=true; 
             for (var i = 0; i < $scope.productList.length; i++) {
                    if ($scope.productList[i].status == "minus") {
    ...
    $scope.getproductBySelectedItemforcpgbyretailer = function (deptmName,productname) {
      ...
      $scope.barchartapicallstatus=false;
                    ...
                    $scope.getselectedproductsbyStoreIdforcpg =function(deptmName,productname) {
                      ...
                      //console.log("p name ", barchartDataObject);
              ...
              if($scope.ProductsbyCT[i]&&$scope.ProductsbyRT[i]){
                ...
                if($scope.ProductsbyRT[i]){
                  var linechartdataobject = {
                   ...
                   // console.log("data...",$scope.linechartData);
                  }
                            var linechartObject={
                              "id":$scope.singleProductLinechartId,
                              "data":$scope.linechartData,
    ...
    $scope.shareOfCategoryByAllRetailers= function (upc) {
          ...
          for(var i=0;i<$scope.itemsList.length;i++){
          if($scope.itemsList[i].itemNumber==upc){
            $scope.itemsList[i].linechart.shoppingtrips=$scope.ABtotal;
            $scope.itemsList[i].barchart.shoppingtrips=$scope.ABtotal;
          }
         }
            }, function (response) {
              console.log(response);
      ...
      $scope.ShareOfBasketByAllRetailer = function (upc) {
          ...
          for(var i=0;i<$scope.itemsList.length;i++){
          if($scope.itemsList[i].itemNumber==upc){
            $scope.itemsList[i].linechart.avgbasket=$scope.STIndex;
            $scope.itemsList[i].barchart.avgbasket=$scope.STIndex;
          }
         }
            }, function (response) {
              console.log(response);
   ...
   //console.log("itemsList",$scope.itemsList);
    ...
    var barchartDataObject = {
        ...
        console.log(response);
         ...
         $scope.shareOfCategoryByDMA= function (upc) {
          $scope.shareOfCategoryByRTbyDMA = function () {
            var ShoppingTripsdata = {
         ...
         productService.getAvgBasketforDistributor(ShoppingTripsdata).then(function (response) {
           $scope.avgBasketTotalByCP = parseFloat(response.data.total);
          $scope.shareOfCategoryByRTbyDMA();
      ...
      $scope.ShareOfBasketByDMA = function (upc) {
          $scope.avgBasketByRTbyDMA = function () {
            var ShoppingTripsdata = {
               "aggTimeUnit": "1d",
               "startTime":$scope.ReportstartDate,
               "endTime":$scope.Reportenddate,
